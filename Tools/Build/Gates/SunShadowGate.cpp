...
//                                                        SUNSHADOWGATE.CPP
//============================================================================================================================================
// Sun-shadow gate — the GI-off shadow stage must place a tap for the sun.
//
...
{
    std::printf("================================================================================\n");
    std::printf("   SUN SHADOW GATE — the GI-off shadow stage must give the sun a tap\n");
    std::printf("================================================================================\n");
