...
// The shader text is written in GLSL literal style (`vec3(0.2126, 0.7152, 0.0722)`): every real number is a double
//    literal in C++ mode, and MSVC reports the implicit double→float conversions GLSL performs silently as
//    C4244/C4305. The text stays unsuffixed (Slang and GLSL consume the same characters); the C++ translation
//    silences the two numbers for exactly the length of the include.
#if defined(_MSC_VER)
#pragma warning(push)
