...
The skull carries two receiver-like Wi-Fi antennae mounted anterior to the eye sockets. Two hydraulic jaw actuators are anchored between the skull and mandible, so their barrels and pistons visibly compress and extend with the live jaw transform. Exactly three electrical cables run from the throat bus toward the stomach: one emissive yellow main cable and orange and red secondary cables. They use Verlet integration with segment constraints, gravity, damping and moving anatomical anchors, so they sag and lag during turns and attacks instead of staying as rigid lines. The pelvis/acetabula and IK hip joints are offset left and right from the midline; turns articulate the pelvis, trunk vertebrae, neck, head and trailing tail with delayed counter-rotation.
