...
export const WEATHER_PROFILES = [
  {
    ...
    name: "Rain",
    description:
      "Volume-budgeted rain falls onto the actual XYZ SDF and continues as sediment-carrying runoff. Diameter affects fall speed, not the coarse erosion footprint. Water is measured in m³; rain rate is mm/hour. Flat, undriven ground cannot continuously excavate itself. Loose sediment is easier to entrain than the assumed resistant substrate. Select Hydraulic shaping for fine-grid terrain authoring instead of a timed rainfall study.",
    footprint: 0.47,
    agentDiameter: 3,
    restitution: 0.08,
    min: 0.5,
  ...
  },
  {
    ...
    name: "River",
    description:
      "Draw a shared river route first. Agents enter at point 1 and follow its direction, elevation and width; the water shader uses that same path.",
    footprint: 0.52,
    agentDiameter: 10,
    restitution: 0.03,
    min: 2,
