...
| `Verification/plant_smoke.mjs` | `node Verification/plant_smoke.mjs` — 33 plants × 20 seeds: single connected mesh, finite positions, valid indices, height range, colour attribute present, no UVs, determinism, uniqueness. |
