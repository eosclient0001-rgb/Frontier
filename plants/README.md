...
- **15 production plants** in 2 focused categories — Grasses and Cactus / Desert. Legacy shrubs, flowers, vegetables, weeds, ferns, and alpine assets are intentionally removed from the catalogue. The cactus set covers Saguaro, Golden Barrel, Prickly Pear, Agave, and Ocotillo with botanical records, age, fruit-load, and seed-set controls. All smooth-shaded,
...
- Cactus records include scientific family, growth form, native range, mature scale, lifespan, fruit, seed biology, and human/ecological uses. Every specimen gets a contact-shadow disc so nothing floats; soil mounds
  ground each plant.
