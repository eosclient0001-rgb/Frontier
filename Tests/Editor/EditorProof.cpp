...
int main()
{
    ...
    const char* Sheet = "Tests/VisualProofs/Editor/EditorProof_Tabs.png";
    ...
    Rasterise();
    {
        const char* MenuSheet = "Tests/VisualProofs/Editor/EditorProof_Menu.png";
    ...
    Rasterise();
    {
        const char* NarrowSheet = "Tests/VisualProofs/Editor/EditorProof_Filtered.png";
    ...
    Rasterise();
    {
        const char* PaletteSheet = "Tests/VisualProofs/Editor/EditorProof_Palette.png";
    ...
    Rasterise();
    {
        const char* ViewsSheet = "Tests/VisualProofs/Editor/EditorProof_Views.png";
    ...
    Rasterise();
    {
        const char* InspectorSheet = "Tests/VisualProofs/Editor/EditorProof_Inspector.png";
    ...
    // Gate 13 — open and close: the pull toggles, the grip closes, drags carry both ways.
    {
        ...
        Rasterise();
        const char* ShadeSheet = "Tests/VisualProofs/Editor/EditorProof_Shade.png";
    ...
    auto CycleTab = [&](float MarkX, uint32_t Tab, uint32_t Row, bool Capture, float RaiseX = 0.0f)
    {
        ...
        {
            Rasterise();
            const char* TabMenuSheet = "Tests/VisualProofs/Editor/EditorProof_TabMenu.png";
